...
pub fn basic_ui_pipeline(
    ...
    let vertex_input_info = vk::PipelineVertexInputStateCreateInfo {
        vertex_binding_description_count: VertexUi::GET_BINDING_DESCRIPTION.len() as _,
        vertex_attribute_description_count: VertexUi::GET_ATTRIBUTE_DESCRIPTIONS.len() as _,
        p_vertex_binding_descriptions: VertexUi::GET_BINDING_DESCRIPTION.as_ptr(),
        p_vertex_attribute_descriptions: VertexUi::GET_ATTRIBUTE_DESCRIPTIONS.as_ptr(),
        ..Default::default()
    };
